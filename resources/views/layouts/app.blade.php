...
<div class="flex min-h-screen">
    ...
    auth()->user()->hasPermission('view-bookings')||auth()->user()->hasPermission('cancel-bookings'))
                <div class="block text-gray-700 hover:text-blue-500">
            ...
            @endif
            @if(auth()->user()->hasPermission('view-booking-history'))
                 
                <div class="block text-gray-700 hover:text-blue-500">

                    <a href="{{ route('bookings.history') }}">Booking History</a>
                </div>
            @endif
        </nav>
    </aside>
