...
Route::middleware(['auth','permission:create-bookings'])->group(function () {
...
Route::middleware(['auth','permission:cancel-bookings'])->group(function () {
    Route::delete('bookings/{id}/delete', [BookingController::class, 'destroy'])->name('bookings.destroy');
    Route::get('bookings', [BookingController::class, 'index'])->name('bookings.index');
});

Route::middleware(['auth','permission:view-booking-history'])->group(function () {
